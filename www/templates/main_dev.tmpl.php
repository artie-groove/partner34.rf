    	            ...
    	            <div class="row">
    	                <div class="col-sm-6">
    	                    <div class="row">
    	                    	<div class="col-xs-7">
    	                    		<address>
    	                    		    <h4>Волгоград<br /><span class="small">ул.&nbsp;Хиросимы,&nbsp;16&nbsp;б</span></h4>
    	                    		    <table>
    	                                	<col width="30" />
    	                    		    	<tr>
    	                        ...
    	                        <div class="col-xs-5 routeto">
    	                        	<a href="/map/"><span class="glyphicon glyphicon-circle-arrow-right"></span><br />схема<br />проезда</a>
    	                        </div>
    	                    </div>
    	                </div>
    	                <div class="col-sm-6">
                ...
                <div class="col-md-7 col-md-offset-1 col-sm-12 hidden-xs hidden-sm">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8">
                            <a href="/road_incident_1/">
                                <img src="/_img/road_incident.jpg" width="100%" alt="Экспертиза ДТП"/>
                                <h3 class="h3">Экспертиза ДТП</h3>
                            </a>
                            <ul>
        ...
        <div class="container">
            <div class="row hidden-xs">
	            <div class="col-sm-6 col-md-4">
            		<address>
            		    400050, г.&nbsp;Волгоград, ул.&nbsp;Хиросимы,&nbsp;16&nbsp;б<br />
